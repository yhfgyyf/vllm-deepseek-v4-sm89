...
Checks:
  ...
  3. The block-FP8 Triton GEMM (UPCAST_FP8 path) matches a bf16 dequant
     reference -- this is the dense/attention linear workhorse and the
     highest-risk SM80 change (B-1).
"""
...
def check_block_fp8_gemm() -> None:
    ...
    print("  [OK] block-FP8 UPCAST_FP8 GEMM\n")
