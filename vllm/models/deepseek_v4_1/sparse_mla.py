...
"""DeepSeek-V4.1 sparse-attention metadata and metadata builders."""
...
# differ in compressed page block size (block_size // ratio).
...
class DeepseekV41SparseMLABackend(AttentionBackend):
    ...
    @staticmethod
    def get_builder_cls() -> type["DeepseekV41SparseMLAMetadataBuilder"]:
        return DeepseekV41SparseMLAMetadataBuilder
    ...
    def get_impl_cls() -> type[Any]:
        ...
        raise NotImplementedError(
            "DeepseekV41SparseMLABackend has no separate impl class; DeepSeek-V4.1 "
...
@dataclass
class DeepseekV41SparseMLAMetadata(AttentionMetadata):
    num_reqs: int
    max_query_len: int
    max_seq_len: int
...
class DeepseekV41SparseMLAMetadataBuilder(
    AttentionMetadataBuilder[DeepseekV41SparseMLAMetadata]
):
    ...
    def build(
        ...
        return DeepseekV41SparseMLAMetadata(
