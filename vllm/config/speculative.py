            ...
            if self.model is not None:
                ...
                # deepseek-ai/dspark_qwen3_8b_block7
                    ...
                    if (
                        ...
                        raise ValueError(
                            "DeepSeek V4.1 checkpoints contain DSpark stages, "
                            "not classic MTP. Use speculative method 'dspark'."
                        )
                    if (
                ...
                is_deepseek_v4_dspark = (
                    self.method == "dspark"
                    and "DSparkDraftModel" in self.draft_model_config.architectures
                    and self.draft_model_config.hf_config.model_type == "deepseek_v4"
                )
